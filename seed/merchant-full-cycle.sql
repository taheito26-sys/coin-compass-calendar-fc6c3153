...
-- ============ DEALS ============
INSERT INTO merchant_deals (id, relationship_id, deal_type, title, amount, currency, status, issue_date, due_date, expected_return, metadata, created_by, created_at, updated_at) VALUES
...
INSERT INTO merchant_deals (id, relationship_id, deal_type, title, amount, currency, status, issue_date, due_date, expected_return, realized_pnl, close_date, metadata, created_by, created_at, updated_at) VALUES
...
INSERT INTO merchant_deals (id, relationship_id, deal_type, title, amount, currency, status, issue_date, metadata, created_by, created_at, updated_at) VALUES
...
-- ============ SETTLEMENTS ============
INSERT INTO merchant_settlements (id, deal_id, relationship_id, paid_amount, paid_date, variance_note, submitted_by, status, created_at) VALUES
...
-- ============ PROFIT RECORDS ============
INSERT INTO merchant_profit_records (id, deal_id, relationship_id, period, gross_profit, net_distributable, share_a, share_b, note, submitted_by, status, created_at) VALUES
...
-- ============ APPROVALS ============
INSERT INTO merchant_approvals (id, relationship_id, type, target_entity_type, target_entity_id, proposed_payload, status, submitted_by_user_id, submitted_by_merchant_id, submitted_at) VALUES
...
INSERT INTO merchant_approvals (id, relationship_id, type, target_entity_type, target_entity_id, proposed_payload, status, submitted_by_user_id, submitted_by_merchant_id, submitted_at, reviewed_by_user_id, reviewed_by_merchant_id, reviewed_at, review_note) VALUES
...
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
  ('msg00003-0000-0000-0000-000000000003', 'rel00001-0000-0000-0000-000000000001', 'aaa00001-0000-0000-0000-000000000001', 'Deal created. BTC Spot Lending Q1 activated for 50k USDT.', '["aaa00001-0000-0000-0000-000000000001","bbb00000-0000-0000-0000-000000000000"]', '2026-01-25T10:05:00Z');
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
  ('msg00004-0000-0000-0000-000000000004', 'rel00001-0000-0000-0000-000000000001', 'aaa00001-0000-0000-0000-000000000001', 'Dec ETH lending fully settled. 21,050 USDT returned.', '["aaa00001-0000-0000-0000-000000000001","bbb00000-0000-0000-0000-000000000000"]', '2026-02-28T16:30:00Z');
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
  ('msg00005-0000-0000-0000-000000000005', 'rel00002-0000-0000-0000-000000000002', 'aaa00002-0000-0000-0000-000000000002', 'Launching DeFi yield strategy. 100k USDT, 12% annualized, 60/40 split.', '["aaa00002-0000-0000-0000-000000000002","bbb00000-0000-0000-0000-000000000000"]', '2026-02-04T15:00:00Z');
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
...
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
  ('msg00007-0000-0000-0000-000000000007', 'rel00002-0000-0000-0000-000000000002', 'aaa00002-0000-0000-0000-000000000002', 'Aave v3, Compound, Curve pools. Feb report: 4.2% gross.', '["aaa00002-0000-0000-0000-000000000002","bbb00000-0000-0000-0000-000000000000"]', '2026-03-01T08:30:00Z');
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
  ('msg00008-0000-0000-0000-000000000008', 'rel00002-0000-0000-0000-000000000002', 'aaa00002-0000-0000-0000-000000000002', 'Proposing SOL accumulation pool - 30k USDT weekly DCA. Please review draft.', '["aaa00002-0000-0000-0000-000000000002"]', '2026-03-08T14:15:00Z');
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
  ('msg00009-0000-0000-0000-000000000009', 'rel00002-0000-0000-0000-000000000002', 'aaa00002-0000-0000-0000-000000000002', 'March W1 profit submitted: $1,850 gross. Approval sent.', '["aaa00002-0000-0000-0000-000000000002"]', '2026-03-08T09:15:00Z');
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
  ('msg00010-0000-0000-0000-000000000010', 'rel00003-0000-0000-0000-000000000003', 'aaa00003-0000-0000-0000-000000000003', 'ETH triangular arb closed. $1,350 profit. Settlement submitted.', '["aaa00003-0000-0000-0000-000000000003","bbb00000-0000-0000-0000-000000000000"]', '2026-02-18T17:10:00Z');
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
  ('msg00011-0000-0000-0000-000000000011', 'rel00003-0000-0000-0000-000000000003', 'aaa00003-0000-0000-0000-000000000003', 'New BTC CEX arb opportunity. 75k USDT, 2% target in 30d.', '["aaa00003-0000-0000-0000-000000000003","bbb00000-0000-0000-0000-000000000000"]', '2026-02-15T11:15:00Z');
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
...
INSERT INTO merchant_messages (id, relationship_id, sender_merchant_id, body, read_by, created_at) VALUES
  ('msg00013-0000-0000-0000-000000000013', 'rel00003-0000-0000-0000-000000000003', 'aaa00003-0000-0000-0000-000000000003', 'Partial close on BTC arb. $25k settlement submitted for approval.', '["aaa00003-0000-0000-0000-000000000003"]', '2026-03-09T10:10:00Z');
