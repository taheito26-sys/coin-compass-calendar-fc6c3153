...
INSERT INTO merchant_approvals (id, relationship_id, type, target_entity_type, target_entity_id, proposed_payload, status, submitted_by_user_id, submitted_by_merchant_id, resolution_note, submitted_at, resolved_at) VALUES
...
-- ============ MESSAGES ============
INSERT INTO merchant_messages (id, relationship_id, sender_user_id, sender_merchant_id, message_type, body, read_by, created_at) VALUES
...
-- ============ NOTIFICATIONS ============
INSERT INTO merchant_notifications (id, user_id, merchant_id, category, title, body, link_type, link_id, created_at) VALUES
